...
export function Header() {
  return (
    <header className="bg-red-400 dark:bg-slate-700 w-full md:w-2/3 flex gap-1 items-center justify-center rounded-b-3xl py-2 mb-2 duration-500 delay-100 ease-in-out shadow-[0_0_6px_0_rgba(0,0,0,0.3)]">
